 ...
 *
 *
 * mod_vr_test_1.c -- Framework Demo Module
 *
 */
#include <switch.h>

/* Prototypes */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_vr_test_1_shutdown);
SWITCH_MODULE_RUNTIME_FUNCTION(mod_vr_test_1_runtime);
SWITCH_MODULE_LOAD_FUNCTION(mod_vr_test_1_load);

/* SWITCH_MODULE_DEFINITION(name, load, shutdown, runtime)
 * Defines a switch_loadable_module_function_table_t and a static const char[] modname
 */
SWITCH_MODULE_DEFINITION(mod_vr_test_1, mod_vr_test_1_load, mod_vr_test_1_shutdown, NULL);
...
static switch_status_t do_config(switch_bool_t reload)
{
	...
	if (switch_xml_config_parse_module_settings("vr_test.conf", reload, instructions) != SWITCH_STATUS_SUCCESS) {
		switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_CRIT, "Could not open vr_test.conf\n");
...
/* Macro expands to: switch_status_t mod_vr_test_1_load(switch_loadable_module_interface_t **module_interface, switch_memory_pool_t *pool) */
SWITCH_MODULE_LOAD_FUNCTION(mod_vr_test_1_load)
{
...
/*
  ...
  Macro expands to: switch_status_t mod_vr_test_1_shutdown() */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_vr_test_1_shutdown)
{
...
/*
  ...
  Macro expands to: switch_status_t mod_vr_test_1_runtime()
SWITCH_MODULE_RUNTIME_FUNCTION(mod_vr_test_1_runtime)
{
	while(looping)
	{
