#ifndef __LWS_AUDIO_DOCKER_GLUE_H__
#define __LWS_AUDIO_DOCKER_GLUE_H__
...
switch_status_t audio_docker_session_init(switch_core_session_t *session, responseHandler_t responseHandler,
...
switch_status_t audio_docker_service_threads();
#endif
