 ...
 *
 *
 * mod_vr_test.c -- Framework Demo Module
 *
 */
#include <switch.h>

/* Prototypes */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_vr_test_shutdown);
SWITCH_MODULE_RUNTIME_FUNCTION(mod_vr_test_runtime);
SWITCH_MODULE_LOAD_FUNCTION(mod_vr_test_load);

/* SWITCH_MODULE_DEFINITION(name, load, shutdown, runtime)
 * Defines a switch_loadable_module_function_table_t and a static const char[] modname
 */
SWITCH_MODULE_DEFINITION(mod_vr_test, mod_vr_test_load, mod_vr_test_shutdown, NULL);
...
/* Macro expands to: switch_status_t mod_vr_test_load(switch_loadable_module_interface_t **module_interface, switch_memory_pool_t *pool) */
SWITCH_MODULE_LOAD_FUNCTION(mod_vr_test_load)
{
...
/*
  ...
  Macro expands to: switch_status_t mod_vr_test_shutdown() */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_vr_test_shutdown)
{
...
/*
  ...
  Macro expands to: switch_status_t mod_vr_test_runtime()
SWITCH_MODULE_RUNTIME_FUNCTION(mod_vr_test_runtime)
{
	while(looping)
	{
